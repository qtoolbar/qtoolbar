...
NotOnThisPlatform=This setup program will not run on %1. Other versions are available at http://www.quero.at/
...
WelcomeLabel2=This will install [name/ver] on your computer.%n%nQuero Toolbar is an add-on for%nMicrosoft Internet Explorer 5.5 or later.%n%nhttp://www.quero.at/%n%nIt is recommended that you close all other applications before continuing.
