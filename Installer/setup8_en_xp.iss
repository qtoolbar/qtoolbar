...
AppVerName=Quero Toolbar 8 Build XP
...
OutputBaseFilename=QueroToolbarInstaller_xp
...
[Files]
Source:"..\Build\output\QueroBroker\xp\QueroBroker.dll"; DestDir:"{app}"; MinVersion:0,5.01; Flags:ignoreversion;
Source:"..\Build\output\QueroBroker\xp\QueroBroker.exe"; DestDir:"{app}"; AfterInstall:RegisterQueroBroker; MinVersion:0,5.01; Flags:ignoreversion;
Source:"..\Profiles\8000\QueroProfiles.reg"; DestDir:"{app}"; AfterInstall:InstallSearchProfiles; Flags:deleteafterinstall ignoreversion;
Source:"..\Build\output\en_xp\Quero.dll"; DestDir:"{app}"; Flags:ignoreversion regserver;

[UninstallRun]
Filename:"{app}\QueroBroker.exe"; Parameters:"/UnregServer"; MinVersion:0,5.01;

[Run]
Filename:"{pf}\Internet Explorer\iexplore.exe"; Parameters:"res://{app}\Quero.dll/installed.html"; Description: "Open Internet Explorer and show Quero tips"; Flags:postinstall skipifsilent nowait;
