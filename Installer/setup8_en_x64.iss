...
OutputBaseFilename=QueroToolbarInstaller_x64
...
Source:"..\Build\output\en_x86\Quero.dll"; DestDir:"{app}"; Flags:ignoreversion regserver 32bit;
Source:"..\Build\output\en_x64\Quero.dll"; DestDir:"{app}\x64"; Flags:ignoreversion regserver 64bit;
...
[Run]
Filename:"{pf}\Internet Explorer\iexplore.exe"; Parameters:"res://{app}\x64\Quero.dll/installed.html"; Description: "Open Internet Explorer and show Quero tips"; Flags:postinstall skipifsilent nowait;
