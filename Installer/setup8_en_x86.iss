...
AppVerName=Quero Toolbar 8 Build [x86] Windows 8, Windows 7, Windows Vista
...
OutputBaseFilename=QueroToolbarInstaller_x86
...
Source:"..\Build\output\en_x86\Quero.dll"; DestDir:"{app}"; Flags:ignoreversion regserver;
