...
OutputBaseFilename=QueroToolbarInstaller_DE_x86
...
Source:"..\Build\output\de_x86\Quero.dll"; DestDir:"{app}"; Flags:ignoreversion regserver;
...
(* English
  ...
  TXT_CLOSE_IE_WARNING = 'Setup will close Internet Explorer';
(* German *)
