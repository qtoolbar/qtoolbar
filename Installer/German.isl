...
NotOnThisPlatform=Dieses Setup-Programm kann nicht unter %1 ausgeführt werden. Andere Versionen verfügbar unter http://www.quero.at/
...
WelcomeLabel2=Dieser Assistent wird jetzt [name/ver] auf Ihren Computer installieren.%n%nQuero Toolbar ist ein Add-On für den%nMicrosoft Internet Explorer 5.5 oder höher.%n%nhttp://www.quero.at/%n%nSie sollten alle anderen Anwendungen beenden, bevor Sie mit dem Setup fortfahren.
