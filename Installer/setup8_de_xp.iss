...
OutputBaseFilename=QueroToolbarInstaller_DE_xp
...
Source:"..\Build\output\de_xp\Quero.dll"; DestDir:"{app}"; Flags:ignoreversion regserver;

[UninstallRun]
Filename:"{app}\QueroBroker.exe"; Parameters:"/UnregServer"; MinVersion:0,5.01;

[Run]
Filename:"{pf}\Internet Explorer\iexplore.exe"; Parameters:"res://{app}\Quero.dll/installed.html"; Description: "Internet Explorer öffnen und Quero-Tipps anzeigen"; Flags:postinstall skipifsilent nowait;
